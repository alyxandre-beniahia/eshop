...
class OrderDetails {
    private $conn;
    private $table_name = "ordersDetails";
    ...
    function create() {
        $query = "INSERT INTO " . $this->table_name . " SET total=:total, created_at=:created_at, modified_at=:modified_at";

        $stmt = $this->conn->prepare($query);

        $this->sanitize();

        $stmt->bindParam(":quantity", $this->total);
    ...
    function update() {
        $query = "UPDATE " . $this->table_name . " SET total=:total, created_at=:created_at, modified_at=:modified_at WHERE id=:id";
