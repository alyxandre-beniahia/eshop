...
class OrderItems {
    private $conn;
    private $table_name = "ordersItems";
    ...
    function create() {
        $query = "INSERT INTO " . $this->table_name . " SET quantity=:quantity, created_at=:created_at, modified_at=:modified_at";
    ...
    function update() {
        $query = "UPDATE " . $this->table_name . " SET quantity=:quantity, created_at=:created_at, modified_at=:modified_at WHERE id=:id";
